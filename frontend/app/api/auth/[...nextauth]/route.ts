  ...
  providers: [
    ...
    CredentialsProvider({
      ...
      async authorize(credentials) {
        ...
        try {
          const apiUrl = process.env.NEXT_PUBLIC_API_URL + "/user/auth";
          console.log("NextAuth Authorize - Attempting login at:", apiUrl);
          ...
          if (res.ok) {
            ...
            console.log("NextAuth Authorize - Login success for:", user.email || user.username);
            ...
            console.error("NextAuth Authorize - Login failed. Status:", res.status, "Body:", errorText);
